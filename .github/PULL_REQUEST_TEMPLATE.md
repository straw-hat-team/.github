<!--
  Comments like this one do not show up on GitHub, leave them as they are.
  Keep the scope small. It is up to you to convince us to land it.
-->

### Checklist

- [ ] I read the [Contributing guide](https://github.com/straw-hat-team/.github/blob/main/CONTRIBUTING.md) and the [Support guide](https://github.com/straw-hat-team/.github/blob/main/SUPPORT.md)
