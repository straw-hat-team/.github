...
This policy defines how the Straw Hat team expects contributors to engage with the project while
...
The Straw Hat team makes use of AI coding tools every day and we expect that almost all contributors
will be doing the same. Therefore, we do not require any disclosure for the usage of AI in any
contributions.
...
- **Use the templates:** PRs and issues have templates, so use them and provide the information they
  are requesting. An incoming submission that ignores the template is a clear sign your agent opened
  it for you and you didn't take much care during the process.
...
Reviewing pull requests is one of the best ways to learn a codebase, and it's a path toward becoming
a maintainer, so we appreciate more people doing it. But that depends on you being the one doing the
reviewing.
